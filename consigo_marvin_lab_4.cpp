...
int main(){
    ...
    cout << enqueue("Dito Sa'kin by Earl Agustin") << endl;
    cout << enqueue("Buwan by Juan Karlos") << endl;
    cout << enqueue("Perfect by Ed Sheeran") << endl; 
    
    cout << "\tTHE ADDED SONGS" << endl;

    cout << karaoke_queue[0] << endl;
    cout << karaoke_queue[1] << endl;
    cout << karaoke_queue[2] << endl;
    
    cout << "\tTHE DELETED SONGS" << endl;
